...
const NUL_CHARACTER_PATTERN = /\0/;// A `#` comment runs to end of line, so a newline is the only character that can escape it — every// The directory is emitted inside 'single quotes', where bash and zsh both leave history expansion
