...
export const en = {
  ...
  maestroControl: {
    chat: {
      ...
      clearWorkspaceTitle: 'Clear the workspace?',
      clearWorkspaceContent: 'This chat stops being bound to "{name}". To use it again, choose the workspace again.',
      clearWorkspace: 'Clear workspace',
      keepWorkspace: 'Keep it',
