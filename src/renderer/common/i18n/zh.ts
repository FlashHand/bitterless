...
export const zh: typeof en = {
  ...
  app: {
    ...
    onlyPreviewFileMenu: {
      ...
      deleteManyMenu: '删除 {count} 个项目…',
      deleteConfirmFileTitle: '删除“{name}”？',
      deleteConfirmFolderTitle: '删除“{name}”及其全部内容？',
      deleteConfirmManyTitle: '删除 {count} 个项目？',
      deleteConfirmSingleMessage: '将立即从磁盘移除，且无法撤销。',
      deleteConfirmManyMessage: '将立即从磁盘移除，且无法撤销。',
      deleteMoreLabel: '…还有 {count} 个',
      deleteFolderTag: '文件夹',
      deleteConfirmHintMac: '⌘⏎',
      deleteConfirmHint: 'Ctrl+⏎',
      deletePartialTitle: '部分项目未被删除',
      deletePartialMessage: '已删除 {total} 个中的 {done} 个。\n“{name}”删除失败。',
      deleteProgressTitle: '正在删除…',
      deleteProgressMessage: '大目录可能需要一些时间。',
      deleteProgressCount: '{done} / {total}',
      deleteRootRefusedTitle: '无法删除项目根目录',
      deleteRootRefusedMessage: '请改为选择其中的条目。',
      deleteTooManyTitle: '选择的项目过多',
      deleteTooManyMessage: '每次最多删除 {limit} 个项目。',
      deleteFailureTitle: '无法删除文件',
      deleteFailureMessage: '文件删除失败，它可能已被移动或更改。',
      newFolderTitle: '新建文件夹',
      newFolderDestination: '位于“{name}”',
      newFolderNameLabel: '名称',
      newFolderConfirm: '确定',
      newFolderCancel: '取消',
      newFolderExistsTitle: '名称已被占用',
      newFolderExistsMessage: '“{parent}”中已存在“{name}”。\n请输入其他名称。',
      newFolderExistsRootMessage: '此处已存在“{name}”。\n请输入其他名称。',
      newFolderInvalidTitle: '名称不可用',
      newFolderFailureTitle: '无法新建文件夹',
      newFolderFailureMessage: '无法新建文件夹，项目可能已发生变化。',
      alertOk: '确定',
  ...
  maestroSub2Api: {
    ...
    addCodexLabelPlaceholder: '账号名称',
    addCodexActivate: '切到这个',
    concurrency: '进行中的轮次',
    concurrencyHint: '每个平台同时只有一个账号处于激活状态,由它承担全部轮次,并发数不设上限。激活哪个账号由周额度决定 —— 当前账号用低了会自动切换。',
    activeNow: '激活中',
    addAccountTitle: '添加账号',
    addAdoptTitle: '采纳已登录的环境',
    addAdoptHint: '你已经在终端里登录过的 ~/.claude<N> 目录。不需要重新登录 —— Bitterless 只做校验和登记。',
    addAdoptEmpty: '没有找到已登录的 ~/.claude<N> 目录。先在终端用 CLAUDE_CONFIG_DIR=~/.claude3 claude 登录一个,再打开这个对话框。',
    addClaudeTitle: '登录 Claude 订阅',
    addClaudeHint: '新建一个 ~/.claude<N> 槽位并走 Claude CLI 登录。池子会多出一路并发。',
    addClaudeAction: '开始登录',
    addCodexTitle: '连接 Codex(ChatGPT)',
    addCodexHint: '对 ChatGPT 订阅走浏览器 OAuth,与 Translator 共用。同时只持有一份 —— 连接会替换当前那份。',
    addCodexAction: '连接',
    addCodexReconnect: '重新连接',
    addCodexStarted: '已在浏览器中打开 Codex 登录',
    adoptColumn: '环境目录',
    activeColumn: '活跃',
    codexReady: '可用',
    accountName: '账号名称',
    ...
    weeklyUsage: '套餐用量',
    operation: '操作',
    usageUnknown: '尚未观察到请求',
    resetsAt: '重置于',
    usingOverage: '正在使用额外用量',
    clientTitle: 'OpenAI 兼容客户端',
    clientDescription: '一个本地端点同时供应两份订阅。把 Codex —— 或任何 OpenAI 兼容 agent —— 指过来，模型在它自己的选择器里挑。',
    endpointTitle: '本地大模型端点',
    endpointSubtitle: 'OpenAI 兼容 · Responses API',
    importTitle: '导入到你的 agent',
    importSubtitle: 'Codex，或任何 OpenAI 兼容客户端',
    importStepCopy: '复制下面的 provider 配置块。',
    importStepPaste: '粘贴到 agent 的配置里 —— Codex 是 ~/.codex/config.toml。',
    importStepRestart: '重启 agent，让它重新加载 provider 和模型列表。',
    restartCodexNotice: '已复制。粘贴到 ~/.codex/config.toml，然后重启 Codex —— 正在运行的实例仍用旧的 provider 和模型列表。',
    models: '个模型',
    codexAccounts: 'Codex 订阅',
    codexDescription: '端点的 GPT 一半，走 Bitterless 已经登录的 ChatGPT 会话。',
    codexConnected: '已连接 —— 正在供应 GPT 模型',
    codexDisconnected: '未连接 —— gpt-* 请求会回落到 Claude',
    codexSingleAccountNote: 'Codex 登录是浏览器 OAuth 对 ChatGPT 订阅，Bitterless 同时只持有一份。多 Codex 账号尚未支持。',
    codeAskedAgain: 'Claude 又要了一次授权码。要么它需要第二个，要么上一个没被接受 —— 请从登录窗口取一个新的粘贴。',
