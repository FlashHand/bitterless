...
export const zh: typeof en = {
  ...
  app: {
    ...
    onlyPreviewFileMenu: {
      ...
      defaultAppIsSelfTitle: '当前应用已经是默认查看器',
      defaultAppIsSelfDetail: '再次打开此文件会回到 OnlyPreview。请在 Finder 中选择“打开方式 → 其他”，使用其他应用打开。',
  ...
  maestroControl: {
    chat: {
      ...
      clearWorkspaceTitle: '清除工作区？',
      clearWorkspaceContent: '当前会话将不再关联“{name}”。如需再次使用，需要重新选择该工作区。',
