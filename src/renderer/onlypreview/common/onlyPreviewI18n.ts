...
const en = {
  ...
  globalSearch: {
    ...
    scopeLabel: 'Contents search scope',
  ...
  preview: {
    ...
    imageRotateLeft: 'Rotate image left',
    imageRotateRight: 'Rotate image right',
    ...
    modified: 'Modified',
    encoding: 'Encoding',
    textLimit: 'Text preview is limited to 8 MB. Open it in the default app to inspect it.',
  ...
  errors: {
    ...
    SHEET_RENDER_FAILED: 'The workbook viewer could not render this file.',
    ...
    DOCUMENT_RENDER_FAILED: 'The document viewer could not render this file.',
    ...
    PRESENTATION_RENDER_FAILED: 'The presentation viewer could not render this file.',
...
const zh: Localized<typeof en> = {
  ...
  preview: {
    ...
    unsupportedImageBody: '已识别此图片格式，但当前没有内置解码器。请使用默认应用打开。',
    unsupportedVideoBody: '已识别此媒体容器，但当前没有内置播放器。请使用默认应用打开。',
    ...
    modified: '修改时间',
    encoding: '编码',
    textLimit: '文本预览上限为 8 MB。请使用默认应用查看。',
  ...
  errors: {
    ...
    PRESENTATION_RENDER_FAILED: '演示文稿预览器无法渲染此文件。',
